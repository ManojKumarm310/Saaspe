...
public class Invoice {
	...
	// Invoice button
		...
		// Add button
		private By addbutton = By.xpath("//div[contains(text(),'Add')]");
		...
		public void uploadInvoice() throws AWTException {
		    ...
		    StringSelection selection = new StringSelection("C:\\Users\\lenovo\\Desktop\\Penetration Test Report on Saaspe.pdf");
